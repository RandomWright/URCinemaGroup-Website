...
<html lang="en" class="no-js">
    ...
    <head>
        ...
        <meta name="description" content="Offical website for the University of Rochester Cinema Group.">
		<meta name="author" content="Charlotte Wright">
    ...
    <!-- PHP - HEADER -->
	<?php $selected = 'films'; include "inc/header.inc"; ?>
        ...
        <div class="bg-color-sky-light" >
            <div class="content-md container">
                <div class="row margin-b-40">
                    <div class="col-sm-4">
                        <h2>Films</h2>
                        <p>This schedule is subject to change due to the availability and approval of the distributors.</p>
                    </div>
					<div class="col-sm-8">
						<!-- start feedwind code -->
						<script type="text/javascript" src="https://feed.mikle.com/js/fw-loader.js" data-fw-param="49978/"></script> <!-- end feedwind code -->
					</div>
                </div>
                <!--// end row -->
		...
		<div class="row">
			...
			<div class="responsiveCal">
				<iframe src="https://calendar.google.com/calendar/embed?title=UR%20Cinema%20Group%20Google%20Calendar&amp;showCalendars=0&amp;showTz=0&amp;height=600&amp;wkst=1&amp;bgcolor=%23ffffff&amp;src=ur.cinemagroup%40gmail.com&amp;color=%23711616&amp;ctz=America%2FNew_York" style="border-width:0" width="700" height="500" frameborder="0" scrolling="no"></iframe>
			</div>
			</div>
			<div class="col-md-4">
			<h3>How to Download the Google Calendar:</h3>
				<ul>
					<li>Click on the "+GoogleCalendar" Button on the bottom of the calendar</li>
				</ul>
				<p>Or</p>
				<ul>
				<li>On the left side of the Google Calendar Page, under &quot;Other Calendars&quot; click the Add button in the bottom right corner of the blue box.</li>
				<li>Click &quot;Add by URL&quot;</li>
				<li>Type in the address: <a href="https://calendar.google.com/calendar/ical/ur.cinemagroup%40gmail.com/public/basic.ics"><small>https://calendar.google.com/calendar/ical/ur.cinemagroup%40gmail.com/public/basic.ics</small></a></li>
				<li>You're done!</li>
				</ul>
			<h3>Using Another Calendar Program:</h3>
			<p>Be sure to add an online calendar with the address <small><a href="https://calendar.google.com/calendar/ical/ur.cinemagroup%40gmail.com/public/basic.ics">https://calendar.google.com/calendar/ical/ur.cinemagroup%40gmail.com/public/basic.ics</a>.</small> Remember to have it update the calendar every day!</p>
			</div>
		</div>
		</div>
